...
public class AddUser extends javax.swing.JFrame {
    ...
    public AddUser() {
        ...
        // Poner título
        this.setTitle("Añadir Usuario - DoLists");
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(dni, javax.swing.GroupLayout.DEFAULT_SIZE, 272, Short.MAX_VALUE)
                            .addComponent(nombre))))
    ...
    private void btn_añadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_añadirActionPerformed
        ...
        if(d.matches("[0-9]{8}[A-Z]")) {
            ...
            if(!name.isEmpty()) {
                ...
                try {
                    String msg = o.addUser(d, name);
                    if(msg.equals("error")) JOptionPane.showMessageDialog(rootPane, "Error al añadir el usuario.");
                    else JOptionPane.showMessageDialog(rootPane, "Usuario añadido con éxito.");
